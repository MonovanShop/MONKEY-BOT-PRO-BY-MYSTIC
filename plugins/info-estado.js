...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  const wm = 'The Monkey Bot';
  const info = ` ${tradutor.texto1[0]}

  ${tradutor.texto1[1]} Monovan
  ${tradutor.texto1[2]} +525625768269
  ${tradutor.texto1[3]} https://chat.whatsapp.com/HNLkWdj5A8J8t0x4ogzBZF
